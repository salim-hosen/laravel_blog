            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{ $latest->featured }}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{ $latest->featured }}" class="link-image js-zoom-image">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="{{ route('post.single',['slug' => $latest->slug]) }}">{{ $latest->title }}</a>
                                    </h2>
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="{{ route('post.single',['slug' => $latest->slug]) }}">{{ $second->title }}</a>
                                    </h2>
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="{{ route('post.single',['slug' => $latest->slug]) }}">{{ $third->title }}</a>
                                    </h2>
                          ...
                          @foreach($tutorials->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    ...
                                    <h6 class="case-item__title text-center"><a href="{{ route('post.single',['slug' => $latest->slug]) }}">{{ $post->title }}</a></h6>
                                </div>
                            </div>
                            @endforeach
                        </div>
